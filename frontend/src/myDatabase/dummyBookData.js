export const bookDataDummy = [
  {
    id: 1,
    name: 'Meditation - A First and Last Freedom',
    img: 'https://m.media-amazon.com/images/I/71oNHPRgVUL._AC_UL400_.jpg',
    description:
  ...
  },
  {
    ...
    img: 'https://m.media-amazon.com/images/I/71iQSkrLL7L._AC_UL400_.jpg',
    description: `The principles and practices of Tantra are revealed by one of the greatest spiritual teachers of the twentieth century in The Book of Secrets: 112 Meditations to Discover the Mystery Within.
...
In this comprehensive and practical guide, the secrets of the ancient science of Tantra become available to a contemporary audience. Confined to small, hidden mystery schools for centuries, and often misunderstood and misinterpreted today. Tantra is not just a collection of techniques to enhance sexual experience. As Osho shows in these pages, it is a complete science of self-realization, based on the cumulative wisdom of centuries of exploration into the meaning of life and consciousness. Tantra―the very word means “technique”―is a set of powerful, transformative tools that can be used to bring new meaning and joy to every aspect of our daily lives.`,
  ...
  {
    id: 3,
    name: `Love, Freedom, and Aloneness`,
    img: `https://m.media-amazon.com/images/I/71vg+fDX3cS._AC_UL400_.jpg`,
    description: `Osho cuts through the nonsense of our relationship dramas and shows how we can be in love and yet free, together and yet able to take our own space when we need it.
Where does jealousy come from, and how can we free ourselves from it?
